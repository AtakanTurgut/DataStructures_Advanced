...
namespace graphs.AdjacencySet
{
        ...
        where TW : IComparable
    {
        ...
        {
            var graph = new graphs.AdjacencySet.WeightedGraph<T, TW>();
        ...
        public IEnumerable<T> Edges(T key)
        {
            ...
            return vertices[key].Edges.Select(e => e.Key.Key);
        }
            ...
            where TW : IComparable
        {
            ...
            IEnumerable<IEdge<T>> IGraphVertex<T>.Edges => Edges.Select(e => new Edge<T, TW>(e.Key, e.Value));
