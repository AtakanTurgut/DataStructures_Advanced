...
namespace graphs.sets
{
    public class DisjointSet<T> : IEnumerable<T>
    {
        ...
        {
            if (!set.ContainsKey(value)) throw new Exception("The value is not from this set!");
        ...
        {
            if (valueA == null || valueB == null) throw new ArgumentException();
        ...
        {
            return set.Values.Select(s => s.Value).GetEnumerator();
        }
